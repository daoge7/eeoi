...
import cn.ccsit.common.config.properties.ProjectProperties;
import cn.ccsit.common.xss.XssFilter;
...
public class XssFilterConfig {
    ...
    public FilterRegistrationBean xssFilterRegistrationBean(ProjectProperties properties) {
		 ...
		 * FilterRegistrationBean<Filter>(); registration.setFilter(new XssFilter());
